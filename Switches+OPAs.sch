...
In5L
Text GLabel 8450 1450 1    50   Input ~ 0
In6L
...
In4R
Text GLabel 9050 1450 1    50   Input ~ 0
In5R
Text GLabel 9150 1450 1    50   Input ~ 0
In6R
Text GLabel 9650 1450 1    50   Input ~ 0
In1L
Text GLabel 9750 1450 1    50   Input ~ 0
In2L
Text GLabel 9850 1450 1    50   Input ~ 0
In3L
Text GLabel 9950 1450 1    50   Input ~ 0
In4L
...
In2R
Text GLabel 10550 1450 1    50   Input ~ 0
In3R
Text GLabel 10650 1450 1    50   Input ~ 0
In4R
Text GLabel 10750 1450 1    50   Input ~ 0
In5R
Text GLabel 10850 1450 1    50   Input ~ 0
In6R
Wire Wire Line
	1150 1800 1150 1450
Wire Wire Line
...
In1L
Text GLabel 1250 1450 1    50   Input ~ 0
In2L
...
Text GLabel 1350 4050 3    50   Output ~ 0
Out1L
Text GLabel 2050 4050 3    50   Output ~ 0
Out1R
Text GLabel 3050 4050 3    50   Output ~ 0
Out2L
Text GLabel 3750 4050 3    50   Output ~ 0
Out2R
Text GLabel 4750 4050 3    50   Output ~ 0
Out3L
Text GLabel 5450 4050 3    50   Output ~ 0
Out3R
Text GLabel 6450 4050 3    50   Output ~ 0
Out4L
Text GLabel 7150 4050 3    50   Output ~ 0
Out4R
Text GLabel 8150 4050 3    50   Output ~ 0
Out5L
Text GLabel 8850 4050 3    50   Output ~ 0
Out5R
Text GLabel 9850 4050 3    50   Output ~ 0
Out6L
Text GLabel 10550 4050 3    50   Output ~ 0
Out6R
$Comp
L Amplifier_Operational:TL072 U1
U 3 1 5ECB7E32
P 7750 5700
F 0 "U1" H 7708 5746 50  0000 L CNN
F 1 "TL072" H 7708 5655 50  0000 L CNN
...
U 3 1 5ECB7E33
P 8200 5700
F 0 "U2" H 8158 5746 50  0000 L CNN
F 1 "TL072" H 8158 5655 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 8200 5700 50  0001 C CNN
...
U 3 1 5ECB7E34
P 8650 5700
F 0 "U3" H 8608 5746 50  0000 L CNN
F 1 "TL072" H 8608 5655 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 8650 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tl071.pdf" H 8650 5700 50  0001 C CNN
	3    8650 5700
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 5ECB7E35
P 9100 5700
F 0 "U4" H 9058 5746 50  0000 L CNN
F 1 "TL072" H 9058 5655 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 9100 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tl071.pdf" H 9100 5700 50  0001 C CNN
	3    9100 5700
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 5ECB7E36
P 9550 5700
F 0 "U5" H 9508 5746 50  0000 L CNN
F 1 "TL072" H 9508 5655 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 9550 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tl071.pdf" H 9550 5700 50  0001 C CNN
	3    9550 5700
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 5ECB7E37
P 10000 5700
F 0 "U6" H 9958 5746 50  0000 L CNN
F 1 "TL072" H 9958 5655 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 10000 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tl071.pdf" H 10000 5700 50  0001 C CNN
	3    10000 5700
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5ECB7E38
P 9000 5300
F 0 "#PWR032" H 9000 5150 50  0001 C CNN
F 1 "+9V" H 9015 5473 50  0000 C CNN
...
U 1 1 5ECB7E39
P 9000 6100
F 0 "#PWR033" H 9000 5975 50  0001 C CNN
F 1 "-9V" H 9015 6273 50  0000 C CNN
...
U 1 1 5EC2061D
P 2900 6300
AR Path="/5EC982D9/5EC2061D" Ref="J?"  Part="1" 
AR Path="/5EC982F4/5EC2061D" Ref="J15"  Part="1" 
...
U 1 1 5EC20624
P 5500 6500
AR Path="/5EC982D9/5EC20624" Ref="#PWR?"  Part="1" 
AR Path="/5EC982F4/5EC20624" Ref="#PWR058"  Part="1" 
F 0 "#PWR058" H 5500 6250 50  0001 C CNN
...
U 1 1 5EC2063A
P 3600 5700
AR Path="/5EC982D9/5EC2063A" Ref="#FLG?"  Part="1" 
AR Path="/5EC982F4/5EC2063A" Ref="#FLG01"  Part="1" 
F 0 "#FLG01" H 3600 5775 50  0001 C CNN
F 1 "PWR_FLAG" V 3600 5828 50  0000 L CNN
...
U 1 1 5EC20640
P 3600 6900
AR Path="/5EC982D9/5EC20640" Ref="#FLG?"  Part="1" 
AR Path="/5EC982F4/5EC20640" Ref="#FLG02"  Part="1" 
F 0 "#FLG02" H 3600 6975 50  0001 C CNN
F 1 "PWR_FLAG" V 3600 7028 50  0000 L CNN
...
U 1 1 5EC20646
P 5500 6400
AR Path="/5EC982D9/5EC20646" Ref="#FLG?"  Part="1" 
AR Path="/5EC982F4/5EC20646" Ref="#FLG03"  Part="1" 
F 0 "#FLG03" H 5500 6475 50  0001 C CNN
F 1 "PWR_FLAG" V 5500 6528 50  0000 L CNN
...
U 1 1 5ECA6BDE
P 3600 5950
AR Path="/5EC982D9/5ECA6BDE" Ref="R?"  Part="1" 
AR Path="/5EC982F4/5ECA6BDE" Ref="R25"  Part="1" 
...
U 1 1 5ECB0E31
P 3600 6650
AR Path="/5EC982D9/5ECB0E31" Ref="R?"  Part="1" 
AR Path="/5EC982F4/5ECB0E31" Ref="R26"  Part="1" 
...
U 3 1 5EF3FEAC
P 10450 5700
F 0 "U7" H 10408 5746 50  0000 L CNN
F 1 "TL072" H 10408 5655 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 10450 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tl071.pdf" H 10450 5700 50  0001 C CNN
	3    10450 5700
	1    0    0    -1  
$EndComp
Wire Wire Line
